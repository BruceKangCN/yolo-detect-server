...
class Detector:
    ...
    def find_packed(self, img: np.ndarray) -> list[str]:
        ...
        outputs = self.model.inference(inputs=[rgb])
        boxes = decode_output(
            outputs[0],
